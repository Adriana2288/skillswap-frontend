...
class Profile extends Component {
  ...
  onSubmit = (val) => {
    ...
    axios
      .post(
        "http://localhost:3000/api/profile/registration",
        JSON.stringify(data),
        {
          headers: {
      ...
      <div>
        <form onSubmit={this.onSubmit}>
          ...
          <label>
            ...
            <CountryDropdown value={country} onChange={this.onChangeCountry} />
          </label>
          <br />
          <label>
          ...
          <br />
          <label>Please choose what you would like to teach:</label>
          <input
            type="checkbox"
            name="skill"
            value="music"
